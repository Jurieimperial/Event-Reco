...
class LoginSystem:
    ...
    def create_widgets(self):
        try:
            ...
            self.logo_label = tk.Label(self.root, image=self.logo, bg="#e0f7fa")
            self.logo_label.place(x=20, y=20)
        except Exception as e:
            print(f"Error loading logo: {e}")

        self.greeting_label = tk.Label(self.root, text="Good Day Pupians!", font=("Times new roman", 30), bg="#e0f7fa")
        self.greeting_label.place(x=70, y=150)

        self.login_frame = tk.Frame(self.root, bg="white", highlightbackground="#039be5", highlightthickness=2)
    ...
    def create_login_button(self):
        self.login_button = tk.Button(self.login_frame, text="Log In", bg="#039be5", fg="white", command=self.login)
    ...
    def create_account(self):
        ...
        CreateAcc(create_account_window)
